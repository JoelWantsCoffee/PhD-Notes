Probably worth seeing [this paper](https://arxiv.org/pdf/2106.01999#page=13.26). Fix an abelian category $\def\A{\mathscr{A}}\A$, and define the associated graded functor $\def\gr{\mathrm{gr}}\gr : \mathsf{Filt}(\A) \to \mathsf{Filt}(\A)$ as follows. First, on objects:
$$ 
...
<iframe class="quiver-embed" src="https://q.uiver.app/#q=&embed" width="100%" height="100" style="border-radius: 8px; border: none;"></iframe>
where $G : F \mapsto (n \mapsto F(n \leftarrow n+1))$.
